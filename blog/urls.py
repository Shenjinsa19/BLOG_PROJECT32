...
urlpatterns = [
    ...
    path('my_disliked_posts/', my_disliked_posts_view, name='my-disliked-posts'),     #see what i disliked.................personal
    path('posts/<int:post_id>/comments/', CommentListCreateView.as_view(),name='comment-list-create'),#post ku comm pnu
    path('comments/<int:comment_id>/comments/', comment_replies_view,name='replies'),#anta cmmt ku nested cmt
    ...
    path('comments/<int:pk>/', comment_detail_with_replies_view,name='comment-detail'),#replies of a specific cmt pk........personal...
    ...
    path('users/', user_list_view, name='user-list-view'),#any user view...................................unneccesary
    path('posts/<int:pk>/', post_detail_view, name='post-detail-view'),  #post view,like,dislike
    path('category/', category_list_view, name='category-list'),#view cater.................................unnecessary
